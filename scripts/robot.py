...
class Robot(IdealRobot):
    ...
    def __init__(self, pose, agent=None, sensor=None, color="black", 
                ...
                expected_stuck_time=1e1000, expected_escape_time=1e-100,
...
# for i in range (100):
#     robot = Robot( np.array([0,0,0]).T, sensor=None, agent=circling, color="red",\
#                      noise_per_meter=0, bias_rate_stds=(0.2,0.2),\
#                  expected_stuck_time=5.0, expected_escape_time=5.0, expected_kidnap_time=50)
#     world.append(robot)
